...
@ApplicationScoped
public class JogoFileServiceImpl implements FileServiceJogo {
    // ex = /user/janio/quarkus/images/Jogo
    private final String PATH_USER = System.getProperty("user.home")
        + File.separator + "quarkus"
        + File.separator + "images"
        + File.separator + "Jogo" + File.separator;
    ...
    public void salvar(Long id, String nomeImagem, byte[] imagem) {
        ...
        try {
            Jogo.setNomeImagem(salvarImagem(nomeImagem, imagem));
        } catch (IOException e) {
