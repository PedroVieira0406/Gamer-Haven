...
@ApplicationScoped
public class FuncionarioFileServiceImpl implements FileServiceFuncionario {
    // ex = /user/janio/quarkus/images/Funcionario
    ...
    public void salvar(Long id, String nomeImagem, byte[] imagem) {
        ...
        try {
            Funcionario.setNomeImagem(salvarImagem(nomeImagem, imagem));
        } catch (IOException e) {
