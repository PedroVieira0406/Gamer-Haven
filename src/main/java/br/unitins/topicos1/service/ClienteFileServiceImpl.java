...
@ApplicationScoped
public class ClienteFileServiceImpl implements FileServiceCliente {
    // ex = /user/janio/quarkus/images/Cliente
    ...
    public void salvar(Long id, String nomeImagem, byte[] imagem) {
        ...
        try {
            Cliente.setNomeImagem(salvarImagem(nomeImagem, imagem));
        } catch (IOException e) {
